namespace BobTheBuilder.Tests
{
    public class ItemTests
    {
        ...
        {
            // Arrange & Act
            var item = new Item("Free Hammer", "A free hammer", 0, 0.5, 0);
        ...
        {
            // Arrange & Act
            var material = new Material("Plastic", "Non-sustainable material", 0, 0.3, 5);
